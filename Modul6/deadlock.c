...
int safety(int A[10][10],int N[10][10],int AV[1][10],int n,int m,int a[]){
    int i,j,k,x=0;
    int F[10],W[1][10];
    int pflag=0,flag=0;
    for(i=0;i<n;i++)
...
void accept(int A[10][10],int N[10][10],int M[10][10],int W[1][10],int *n,int *m){
    int i,j;
...
int banker(int A[10][10],int N[10][10],int W[1][10],int n,int m){
    int j,i,a[10];
